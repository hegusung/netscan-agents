...
typedef BOOL (WINAPI * fnFreeLibrary)(HMODULE hLibModule);
...
typedef LCID (WINAPI * fnGetThreadLocale)();
typedef int (WINAPI * fnlstrlenA)(LPCSTR lpString);
typedef BOOL (WINAPI * fnIsBadReadPtr)(const VOID* lp, UINT_PTR   ucb);
